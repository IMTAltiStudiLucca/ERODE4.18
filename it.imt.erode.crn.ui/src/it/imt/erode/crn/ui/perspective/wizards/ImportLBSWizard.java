...
public class ImportLBSWizard  extends Wizard implements IImportWizard,org.eclipse.ui.INewWizard  {

	private IWorkbench workbench;

    private IStructuredSelection selection;

    private WizardImportLBSCreationPage mainPage;

    /**
     * Creates a wizard for importing resources into the workspace from
     * the file system.
     */
    public ImportLBSWizard() {
	...
	public void addPages() {
        super.addPages();
        mainPage = new WizardImportLBSCreationPage(workbench, selection);
        addPage(mainPage);
    }
