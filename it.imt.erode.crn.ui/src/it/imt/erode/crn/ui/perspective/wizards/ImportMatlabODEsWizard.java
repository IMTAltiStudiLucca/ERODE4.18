...
public class ImportMatlabODEsWizard  extends Wizard implements IImportWizard,org.eclipse.ui.INewWizard  {

	private IWorkbench workbench;

    private IStructuredSelection selection;

    private WizardImportMatlabODEsCreationPage mainPage;

    /**
     * Creates a wizard for importing resources into the workspace from
     * the file system.
     */
    public ImportMatlabODEsWizard() {
	...
	public void addPages() {
        super.addPages();
        mainPage = new WizardImportMatlabODEsCreationPage(workbench, selection);
        addPage(mainPage);
    }
