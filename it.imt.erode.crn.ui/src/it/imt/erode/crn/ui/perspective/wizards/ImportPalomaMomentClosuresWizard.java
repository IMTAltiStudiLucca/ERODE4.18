...
public class ImportPalomaMomentClosuresWizard  extends Wizard implements IImportWizard,org.eclipse.ui.INewWizard  {

	private IWorkbench workbench;

    private IStructuredSelection selection;

    private WizardImportPalomaMomentClosuresCreationPage mainPage;

    /**
     * Creates a wizard for importing resources into the workspace from
     * the file system.
     */
    public ImportPalomaMomentClosuresWizard() {
	...
	public void addPages() {
        super.addPages();
        mainPage = new WizardImportPalomaMomentClosuresCreationPage(workbench, selection);
        addPage(mainPage);
    }
