...
public class SpeciesSplayBSTWithTolerance<Key extends BigDecimal, Value extends IBlock> extends SplayBSTWithTolerance<BigDecimal, Value> {

	private List<IBlock> subBlocks;
	private IBlock biggestSubBlock=null;
    
    public SpeciesSplayBSTWithTolerance(Key tolerance) {
		super(tolerance);
    ...
    public String toString(){
    	String ret = "bst (tolerance: "+getTolerance()+"):";
     ...
     *  Returns true if a new block has been created 
     *************************************************************************/
    ...
    public void put(Key key, ISpecies species, IPartition refinedPartition) {
        ...
        int cmp = compareToWithTolerance(key, root.key);
   ...
   /*  @SuppressWarnings("unchecked")
	public boolean put(Key key, ISpecies species, IPartition refinedPartition) {
    	 if(species==null)
    	 {
    		 System.out.println("problem");
    	 }
         // splay key to root
    	 //if(key.compareTo(new BigDecimal(0.0008))==0){
