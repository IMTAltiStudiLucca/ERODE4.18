...
public class FakeSpeciesCompact implements ISpecies, IComposite {
	...
	@Override
	public FakeSpeciesCompact cloneWithoutReactions(){
		FakeSpeciesCompact s = new FakeSpeciesCompact(name,id);
		//s.comments=comments;
		//s.representedEquivalenceClass=representedEquivalenceClass;
		return s;
	}
	
	public FakeSpeciesCompact(String name,int id) {
		this.id=id;
		this.name=name;
	}
